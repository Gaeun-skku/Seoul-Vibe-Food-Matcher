...
raw_spots = [
    ...
    ("우와 홍대본점", "홍대/연남", "#힙한", "토마토 오코노미야끼", 17000, 37.5 side_col = 37.5532, 126.9227),
    ...
    ("익선애뜻", "익선동", "#아늑한", "우대갈비 비빔밥", 15500, 37.5742, 126.892),
